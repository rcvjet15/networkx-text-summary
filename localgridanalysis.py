...
class LocalGridAnalysis:
    ...
    def get_degree_centrality_nodes(self, reverseOrder = True):
    ...
    def get_betweenness_centrality_nodes(self, reverseOrder = True):
    ...
    def get_pagerank_nodes(self, reverseOrder = True):
